...
var $author$project$TypedTitle$Model = F3(
	function (text, shown, cursorVisible) {
		return {z: cursorVisible, J: shown, M: text};
	});
...
var $elm$time$Time$State = F2(
	function (taggers, processes) {
		return {ab: processes, ai: taggers};
	});
...
var $author$project$TypedTitle$subscriptions = function (model) {
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				(!$elm$core$String$isEmpty(model.M)) ? A2($elm$time$Time$every, 100, $author$project$TypedTitle$NextChar) : $elm$core$Platform$Sub$none,
...
var $author$project$TypedTitle$nextChar = function (model) {
	var _v0 = $elm$core$String$uncons(model.M);
	if (!_v0.$) {
		var _v1 = _v0.a;
		var c = _v1.a;
		var rest = _v1.b;
...
var $author$project$TypedTitle$main = $elm$browser$Browser$element(
	{aw: $author$project$TypedTitle$init, aC: $author$project$TypedTitle$subscriptions, aE: $author$project$TypedTitle$update, aF: $author$project$TypedTitle$view});
_Platform_export({'TypedTitle':{'init':$author$project$TypedTitle$main($elm$json$Json$Decode$string)(0)}});}(this));